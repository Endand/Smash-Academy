...
export default async function LessonPage({ params }: Props) {
  ...
  // content is guaranteed non-null — checked above with the notFound() guard
        ...
        <main className="flex-1 min-w-0">
          <div className="max-w-2xl mx-auto px-6 md:px-10 py-10 md:py-14">
            ...
            >
              ...
              <span className="opacity-30">/</span>
              <span style={{ color: "var(--text)" }}>{lesson.titleFallback}</span>
            </nav>

            {/* Title */}
            <h1 className="text-3xl font-extralight tracking-wide text-[var(--text)] mb-5 leading-tight">
              {lesson.titleFallback}
            </h1>

            {/* Introduction */}
            <p className="leading-relaxed text-[15px] mb-10" style={{ color: "var(--text-muted)" }}>
            ...
            <div className="mb-14">
              ...
              <div className="flex flex-col gap-2">
                {content.knowledgeCheck.map((item, i) => (
                  <details
                    key={i}
                    style={{
                      border: "1px solid var(--border-color)",
            ...
            >
              {prevWithContent ? (
                ...
                >
                  ...
                  <div>
                    <div
                      className="font-mono text-[9px] uppercase tracking-widest opacity-50 mb-0.5"
                    >
                      Previous
                    </div>
